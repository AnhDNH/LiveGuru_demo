...
import common.configs.DriverType;
import common.configs.GlobalConstants;
import common.configs.VerificationFailures;
...
public class WebKeywords {
    ...
    protected WebDriver getBrowserDriver(String browserName, String url) {
        DriverType browser = DriverType.valueOf(browserName.toUpperCase());
        if (browser == DriverType.FIREFOX) {
            WebDriverManager.firefoxdriver().setup();
            driver = new FirefoxDriver();
        } else if (browser == DriverType.CHROME) {
